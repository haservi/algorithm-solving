package programmers.Level3.solution._20_사라지는_발판;

/**
 * https://school.programmers.co.kr/learn/courses/30/lessons/92345?language=java
 */
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        int result = solution.solution(board, aloc, bloc);
